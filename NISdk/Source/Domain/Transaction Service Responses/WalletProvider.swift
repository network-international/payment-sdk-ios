...
public enum WalletProvider: String, Codable, CaseIterable {
    ...
    // value makes the whole OrderResponse fail to decode, which breaks otherwise-
    // successful flows — notably the post-3DS getOrder, where it surfaced as a false
    // "payment failed" after a successful challenge.
    case unknown
