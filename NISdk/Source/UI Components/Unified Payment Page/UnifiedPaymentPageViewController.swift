...
class UnifiedPaymentPageViewController: UIViewController {
    ...
    private func buildUI() {
        ...
        // 5. Click to Pay section (if available)
        if availablePaymentOptions.contains(.clickToPay) {
            // Section header
            let ctpHeader = createSectionHeader("Select Other Payment Options")
            contentStackView.addArrangedSubview(ctpHeader)
    ...
    private func createMerchantLogoHeader() -> UIView {
        ...
        container.backgroundColor = UIColor(hexString: "#FAFDFF")

        // Bottom border
        let bottomBorder = UIView()
        bottomBorder.backgroundColor = UIColor(hexString: "#C1C1C1")
        ...
        NSLayoutConstraint.activate([
            ...
            logoView.widthAnchor.constraint(lessThanOrEqualTo: container.widthAnchor, constant: -40),
